...
export default async function NhlTraditionalDraftLotteryPage({
  ...
  /*
   * Permanent Dynasty Draft Lottery route.
   *
   * This route is for the CURRENT league-season startup draft.
   *
   * Example:
   *   league season = 2026
   *   source season = 2026
   *   draft season  = 2026
   *   lottery type  = startup
   *
   * The future 2027 annual/rookie lottery belongs inside the
   * 2026 -> 2027 Offseason workflow and uses:
   *
   *   source season = 2026
   *   draft season  = 2027
   *   lottery type  = rookie
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Watch the official {draftSeason} Dynasty startup draft
            lottery and follow each published draft position live.
          </p>
        </div>
