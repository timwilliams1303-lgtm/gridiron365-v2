...
export default async function TraditionalPlayoffMatchupDetailPage({
  params,
}: PageProps) {
  const {
    leagueId,
  ...
  try {
    data =
      await getTraditionalPlayoffMatchupDetailData(
        supabase,
        leagueId,
        matchupId,
        access.fantasyTeam
    ...
    console.error(
      "Could not load playoff matchup:",
      error
    );
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Week {data.week} Playoff Matchup
          </strong>
