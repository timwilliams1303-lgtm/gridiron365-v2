...
const TraditionalScoring =
  makeComponent(
    "TRADITIONAL",
    "GRIDIRON365 · TRADITIONAL · COMMISSIONER",
    "Traditional leagues use this exact same scoring configuration as Season-Long Salary and No-Salary leagues."
  );

export default TraditionalScoring;
