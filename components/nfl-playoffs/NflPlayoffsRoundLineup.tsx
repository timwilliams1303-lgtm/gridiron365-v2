...
export default function NflPlayoffsRoundLineup({
  leagueId,
  leagueName,
  fantasyTeamId,
  fantasyTeamName,
  ...
  async function removePlayer(
    ...
    try {
      const {
        ...
        await supabase.rpc(
          "remove_nfl_playoff_lineup_player",
          {
            p_league_id:
              leagueId,
  ...
  async function submitLineup() {
    ...
    try {
      ...
      const validationResult =
        await supabase.rpc(
          "validate_nfl_playoff_round_lineup",
          {
            p_league_id:
              leagueId,
      ...
      const submitResult =
        await supabase.rpc(
          "submit_nfl_playoff_round_lineup",
          {
            p_league_id:
              leagueId,
      ...
      if (
        ...
        throw new Error(
          ...
          "The playoff-round lineup could not be submitted."
        );
      }


      setMessage(
        `${roundName} lineup submitted successfully.`
      );
  ...
  return (
    <main
      className="g365-nfl-playoffs-entry-mobile"
      style={
        styles.page
      }
    >
      ...
      <style>{`
        .g365-nfl-playoffs-entry-mobile,
        .g365-nfl-playoffs-entry-mobile * {
        ...
        @media (max-width: 760px) {
          ...
          .g365-nfl-playoffs-entry-mobile section,
          .g365-nfl-playoffs-entry-mobile article,
          .g365-nfl-playoffs-entry-mobile header,
          .g365-nfl-playoffs-entry-mobile form,
          .g365-nfl-playoffs-entry-mobile div {
            min-width: 0;
            max-width: 100%;
          }

          .g365-nfl-playoffs-entry-mobile h1 {
            font-size: clamp(27px, 8vw, 36px) !important;
            line-height: 1.08 !important;
            overflow-wrap: anywhere;
          }

          .g365-nfl-playoffs-entry-mobile h2,
          .g365-nfl-playoffs-entry-mobile h3,
          .g365-nfl-playoffs-entry-mobile p,
          .g365-nfl-playoffs-entry-mobile span,
          .g365-nfl-playoffs-entry-mobile strong {
            overflow-wrap: anywhere;
          }

          .g365-nfl-playoffs-entry-mobile input,
          .g365-nfl-playoffs-entry-mobile select,
          .g365-nfl-playoffs-entry-mobile textarea {
            width: 100% !important;
            max-width: 100% !important;
            min-width: 0 !important;
          ...
          .g365-nfl-playoffs-entry-mobile button,
          .g365-nfl-playoffs-entry-mobile a {
            max-width: 100%;
          }

          .g365-nfl-playoffs-entry-mobile :not(button)[style*="grid-template-columns"] {
            grid-template-columns: minmax(0, 1fr) !important;
          }

          .g365-nfl-playoffs-entry-mobile [style*="white-space: nowrap"],
          .g365-nfl-playoffs-entry-mobile [style*="white-space:nowrap"] {
            white-space: normal !important;
          }

          .g365-nfl-playoffs-entry-mobile [style*="overflow-x: auto"],
          .g365-nfl-playoffs-entry-mobile [style*="overflowX: auto"] {
            max-width: 100%;
      ...
      >
        ...
        >
          <div>
            ...
            >
              NFL PLAYOFFS • {roundName.toUpperCase()}
            </p>
        ...
        >
          ...
          <SummaryCard
            ...
            subtitle="Projected round fantasy points"
          />
        ...
        {isSalary && !salaryPublished ? (
          <div
            style={{
              padding: "14px 16px",
              borderRadius: 12,
              border: "1px solid rgba(255,118,39,.30)",
              background: "rgba(255,118,39,.07)",
              color: "#d7d7dc",
              lineHeight: 1.55,
            }}
          >
            <strong style={{ color: "#ff7627" }}>
              SALARIES NOT PUBLISHED YET
            </strong>
            <div style={{ marginTop: 4, fontSize: 12 }}>
              G365 will publish and freeze this round&apos;s salaries at the scheduled
              Thursday 10:00 PM Eastern publication window after the NFL matchup field
              is complete. Injury information may continue updating, but published
              salaries will not change during the round.
            </div>
          </div>
        ) : null}
              ...
              0 ? (
                ...
                >
                  {activeSlot
                    ...
                    : "Select a lineup slot to begin building your playoff entry."}
                </div>
              ) : (
                filteredPlayers.map(
                  (
