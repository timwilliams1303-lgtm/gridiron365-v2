...
begin
  ...
  -- =========================================================
  -- CAP-PERCENTAGE PRICE CURVE
  -- =========================================================
  --
  -- Existing defaults at a $65,000 cap become percentages:
  --   $3,000 minimum  = 4.6153846% of cap
  --   $12,000 maximum = 18.4615385% of cap
  --   $100 increment  = 0.1538462% of cap
  --
  -- Commissioner-defined monetary salary-engine settings keep the
  -- same relationship to the cap because the entire curve scales.
  -- Weekly increase/decrease guardrails scale by the same percentage.
  -- =========================================================
  ...
  -- Keep displayed/usable player salaries on a clean $100 grid.
  -- The minimum/maximum salary curve still scales as a percentage of
  -- the commissioner-set cap; only the final salary denominations are
  -- normalized for easier lineup building.
  v_increment :=
    100;
  ...
  select
    ...
    jsonb_build_object(
      ...
      'algorithm',
        'gridiron365_dfs_cap_pct_clean100_v4',
